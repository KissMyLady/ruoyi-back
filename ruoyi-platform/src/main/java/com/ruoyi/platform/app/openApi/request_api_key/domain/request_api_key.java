package com.ruoyi.platform.app.openApi.request_api_key.domain;
 ...
 * @date 2023-10-21
 */
public class request_api_key extends BaseEntity {
    ...
    @Excel(name = "key过期时间", width = 30, dateFormat = "yyyy-MM-dd HH:mm:ss")
